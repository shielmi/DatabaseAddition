...
//            mBreakfastDatabaseReference.push().setValue(theRecipe);
            ...
            //Price price = new Price(name,mAmount,mCurrency, mPrice);
            ...
            for (Element el : info) {
                if (el.getElementsByClass("linePrice").first() != null)
                {
                    ...
                    if(mWeight!=null) {
                        mAmount = "" + amount;
                        mQuantity= "NULL";
                        mPriceMeasurement = mWeight;
                    }
                    else{
                        mAmount = "NULL";
                        mQuantity= ""+amount;
                        mPriceMeasurement = "NULL";
                    }
                    //mAmount.add(amounts);
                    Price price = new Price(name,mCurrency, mPrice, mQuantity, mAmount, mPriceMeasurement);
                    mTescoPricesReference.push().setValue(price);
                }
            }
        }
